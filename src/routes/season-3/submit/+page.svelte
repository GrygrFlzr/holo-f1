<script lang="ts">
    import ogImage from "$lib/austria.png?no-inline";
    const raceCount = 11;
    const raceName = "Austria";
</script>
...
<div class="container">
    ...
    <iframe
        ...
        src="https://docs.google.com/forms/d/e/1FAIpQLSfpJqmNqhjskAoswovxaIYZ681JrqvjpYWFJfoZBLlYYR9C1w/viewform?embedded=true"
        frameborder="0"
        marginheight="0"
        marginwidth="0">
        Loading…
