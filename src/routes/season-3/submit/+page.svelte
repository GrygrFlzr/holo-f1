<script lang="ts">
	import ogImage from '$lib/baku.png?no-inline';
	const raceCount = 17;
	const raceName = 'Baku, Azerbaijan';
</script>
...
<div class="container">
	...
	<iframe
		...
		src="https://docs.google.com/forms/d/e/1FAIpQLSeXHEDBcyA7NEoCBod-xtzfRooO0539TdU_zLhTrTBVv3sn0A/viewform?embedded=true"
		frameborder="0"
		marginheight="0"
		marginwidth="0"
	>
